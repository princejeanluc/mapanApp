...
export  default function DateTimePicker({datetime, setDatetime}){
    ...
    return <>
        ...
        <button type="button" onClick={()=>{timePickerWindow.show()}} data-modal-target="timepicker-modal" data-modal-toggle="timepicker-modal"
            ...
            <svg className="w4 h-4 me-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <div className="p-4 pt-0">
                        ...
                        <div className="flex">
                            <input type="time" id="time" name={"time"}
                                   ...
                                   min="09:00" max="18:00" value={time} onChange={(e)=>{setTime(e.target.value)}} required/>
